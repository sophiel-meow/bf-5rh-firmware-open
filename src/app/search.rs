// TODO: make it app or keep in flash
...
mod enabled {
    ...
    use super::super::{App, ChVfoMode, Mode, SearchStatus};
    ...
    pub(in super::super) struct SearchState {
        band: SearchBand,
        phase: SearchPhase,
        sample: Option<u32>,
    ...
    pub(in super::super) fn enter(app: &mut App, _syst: &mut SYST) {
    ...
    pub(in super::super) fn poll(app: &mut App, syst: &mut SYST) {
    ...
    // UI getters
    pub(in super::super) fn band_label(app: &App) -> &'static str {
    ...
    pub(in super::super) fn candidate_freq_hz(app: &App) -> u32 {
        app.search.found_freq_word * 10
    }

    pub(in super::super) fn tone(app: &App) -> Option<SubAudio> {
        app.search.tone
    }
}
...
#[cfg(not(feature = "search"))]
mod disabled {
    use super::super::{App, Mode, SearchStatus};
    ...
    pub(in super::super) fn band_label(_app: &App) -> &'static str {
        ""
    }

    pub(in super::super) fn status(_app: &App) -> SearchStatus {
        SearchStatus::Hunting
    }

    pub(in super::super) fn candidate_freq_hz(_app: &App) -> u32 {
        0
    }

    pub(in super::super) fn tone(_app: &App) -> Option<SubAudio> {
        None
    }
}
