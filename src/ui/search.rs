...
pub(crate) use disabled::{draw_search, Cache};
#[cfg(feature = "search")]
pub(crate) use enabled::{draw_search, Cache};

#[cfg(feature = "search")]
mod enabled {
    use super::super::standby::draw_frequency;
    use super::super::{clear_strip, tone_text, TextBuf, SCREEN_H};
...
mod disabled {
    ...
    pub fn draw_search<D>(_lcd: &mut D, _app: &app::App, _cache: &mut Cache)
    where
        D: DrawTarget<Color = Rgb565>,
    {
    }
