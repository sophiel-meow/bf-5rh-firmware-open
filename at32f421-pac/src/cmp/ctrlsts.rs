...
impl W {
    #[doc = "Bit 0 - Comparator enable bit"]
    #[inline(always)]
    pub fn cmpen(&mut self) -> CmpenW<'_, CtrlstsSpec> {
        CmpenW::new(self, 0)
    }
    #[doc = "Bit 1 - Comparator input shift"]
    #[inline(always)]
    pub fn cmpis(&mut self) -> CmpisW<'_, CtrlstsSpec> {
        CmpisW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Comparator speed selection"]
    #[inline(always)]
    pub fn cmpssel(&mut self) -> CmpsselW<'_, CtrlstsSpec> {
        CmpsselW::new(self, 2)
    }
    #[doc = "Bits 4:6 - Comparator inverting selection"]
    #[inline(always)]
    pub fn cmpinvsel(&mut self) -> CmpinvselW<'_, CtrlstsSpec> {
        CmpinvselW::new(self, 4)
    }
    #[doc = "Bits 7:8 - Comparator non-inverting input selection"]
    #[inline(always)]
    pub fn cmpninvsel(&mut self) -> CmpninvselW<'_, CtrlstsSpec> {
        CmpninvselW::new(self, 7)
    }
    #[doc = "Bits 10:12 - Comparator output target"]
    #[inline(always)]
    pub fn cmptag(&mut self) -> CmptagW<'_, CtrlstsSpec> {
        CmptagW::new(self, 10)
    }
    #[doc = "Bit 15 - Comparator polarity"]
    #[inline(always)]
    pub fn cmpp(&mut self) -> CmppW<'_, CtrlstsSpec> {
        CmppW::new(self, 15)
    }
    #[doc = "Bits 16:17 - Comparator hysteresis"]
    #[inline(always)]
    pub fn cmphyst(&mut self) -> CmphystW<'_, CtrlstsSpec> {
        CmphystW::new(self, 16)
    }
    #[doc = "Bits 18:20 - Comparator blanking"]
    #[inline(always)]
    pub fn cmpblanking(&mut self) -> CmpblankingW<'_, CtrlstsSpec> {
        CmpblankingW::new(self, 18)
    }
    #[doc = "Bit 22 - Comparator brgen"]
    #[inline(always)]
    pub fn brgen(&mut self) -> BrgenW<'_, CtrlstsSpec> {
        BrgenW::new(self, 22)
    }
    #[doc = "Bit 23 - Comparator scalen"]
    #[inline(always)]
    pub fn scalen(&mut self) -> ScalenW<'_, CtrlstsSpec> {
        ScalenW::new(self, 23)
    }
    #[doc = "Bit 31 - Comparator write protect"]
    #[inline(always)]
    pub fn cmpwp(&mut self) -> CmpwpW<'_, CtrlstsSpec> {
        CmpwpW::new(self, 31)
    }
}
