...
impl W {
    #[doc = "Bits 0:1 - Channel 3 configure"]
    #[inline(always)]
    pub fn c3c(&mut self) -> C3cW<'_, Cm2OutputSpec> {
        C3cW::new(self, 0)
    }
    #[doc = "Bit 2 - Channel 3 output immediately enable"]
    #[inline(always)]
    pub fn c3oien(&mut self) -> C3oienW<'_, Cm2OutputSpec> {
        C3oienW::new(self, 2)
    }
    #[doc = "Bit 3 - Channel 3 output buffer enable"]
    #[inline(always)]
    pub fn c3oben(&mut self) -> C3obenW<'_, Cm2OutputSpec> {
        C3obenW::new(self, 3)
    }
    #[doc = "Bits 4:6 - Channel 3 output control"]
    #[inline(always)]
    pub fn c3octrl(&mut self) -> C3octrlW<'_, Cm2OutputSpec> {
        C3octrlW::new(self, 4)
    }
    #[doc = "Bit 7 - Channel 3 output switch enable"]
    #[inline(always)]
    pub fn c3osen(&mut self) -> C3osenW<'_, Cm2OutputSpec> {
        C3osenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Channel 4 configure"]
    #[inline(always)]
    pub fn c4c(&mut self) -> C4cW<'_, Cm2OutputSpec> {
        C4cW::new(self, 8)
    }
    #[doc = "Bit 10 - Channel 4 output immediately enable"]
    #[inline(always)]
    pub fn c4oien(&mut self) -> C4oienW<'_, Cm2OutputSpec> {
        C4oienW::new(self, 10)
    }
    #[doc = "Bit 11 - Channel 4 output buffer enable"]
    #[inline(always)]
    pub fn c4oben(&mut self) -> C4obenW<'_, Cm2OutputSpec> {
        C4obenW::new(self, 11)
    }
    #[doc = "Bits 12:14 - Channel 4 output control"]
    #[inline(always)]
    pub fn c4octrl(&mut self) -> C4octrlW<'_, Cm2OutputSpec> {
        C4octrlW::new(self, 12)
    }
    #[doc = "Bit 15 - Channel 4 output switch enable"]
    #[inline(always)]
    pub fn c4osen(&mut self) -> C4osenW<'_, Cm2OutputSpec> {
        C4osenW::new(self, 15)
    }
}
