...
impl W {
    #[doc = "Bit 3 - Time adjustment flag"]
    #[inline(always)]
    pub fn tadjf(&mut self) -> TadjfW<'_, StsSpec> {
        TadjfW::new(self, 3)
    }
    #[doc = "Bit 5 - Calendar update flag"]
    #[inline(always)]
    pub fn updf(&mut self) -> UpdfW<'_, StsSpec> {
        UpdfW::new(self, 5)
    }
    #[doc = "Bit 7 - Initialization mode enable"]
    #[inline(always)]
    pub fn imen(&mut self) -> ImenW<'_, StsSpec> {
        ImenW::new(self, 7)
    }
    #[doc = "Bit 8 - Alarm A flag"]
    #[inline(always)]
    pub fn alaf(&mut self) -> AlafW<'_, StsSpec> {
        AlafW::new(self, 8)
    }
    #[doc = "Bit 11 - Timestamp flag"]
    #[inline(always)]
    pub fn tsf(&mut self) -> TsfW<'_, StsSpec> {
        TsfW::new(self, 11)
    }
    #[doc = "Bit 12 - Timestamp overflow flag"]
    #[inline(always)]
    pub fn tsof(&mut self) -> TsofW<'_, StsSpec> {
        TsofW::new(self, 12)
    }
    #[doc = "Bit 13 - Tamper detection 1 flag"]
    #[inline(always)]
    pub fn tp1f(&mut self) -> Tp1fW<'_, StsSpec> {
        Tp1fW::new(self, 13)
    }
}
