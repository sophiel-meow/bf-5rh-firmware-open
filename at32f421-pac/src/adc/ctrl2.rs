...
impl W {
    #[doc = "Bit 0 - A/D converter enable"]
    #[inline(always)]
    pub fn adcen(&mut self) -> AdcenW<'_, Ctrl2Spec> {
        AdcenW::new(self, 0)
    }
    #[doc = "Bit 1 - Repeat mode enable"]
    #[inline(always)]
    pub fn rpen(&mut self) -> RpenW<'_, Ctrl2Spec> {
        RpenW::new(self, 1)
    }
    #[doc = "Bit 2 - A/D Calibration"]
    #[inline(always)]
    pub fn adcal(&mut self) -> AdcalW<'_, Ctrl2Spec> {
        AdcalW::new(self, 2)
    }
    #[doc = "Bit 3 - initialize A/D calibration"]
    #[inline(always)]
    pub fn adcalinit(&mut self) -> AdcalinitW<'_, Ctrl2Spec> {
        AdcalinitW::new(self, 3)
    }
    #[doc = "Bit 8 - DMA transfer enable of ordinary channels"]
    #[inline(always)]
    pub fn ocdmaen(&mut self) -> OcdmaenW<'_, Ctrl2Spec> {
        OcdmaenW::new(self, 8)
    }
    #[doc = "Bit 11 - Data alignment"]
    #[inline(always)]
    pub fn dtalign(&mut self) -> DtalignW<'_, Ctrl2Spec> {
        DtalignW::new(self, 11)
    }
    #[doc = "Bits 12:14 - Low bit of trigger event select for preempted channels conversion"]
    #[inline(always)]
    pub fn pctesel(&mut self) -> PcteselW<'_, Ctrl2Spec> {
        PcteselW::new(self, 12)
    }
    #[doc = "Bit 15 - Trigger mode enable for preempted channels conversion"]
    #[inline(always)]
    pub fn pcten(&mut self) -> PctenW<'_, Ctrl2Spec> {
        PctenW::new(self, 15)
    }
    #[doc = "Bits 17:19 - Low bit of trigger event select for ordinary channels conversion"]
    #[inline(always)]
    pub fn octesel(&mut self) -> OcteselW<'_, Ctrl2Spec> {
        OcteselW::new(self, 17)
    }
    #[doc = "Bit 20 - Trigger mode enable for ordinary channels conversion"]
    #[inline(always)]
    pub fn octen(&mut self) -> OctenW<'_, Ctrl2Spec> {
        OctenW::new(self, 20)
    }
    #[doc = "Bit 21 - Conversion trigger by software of preempted channels"]
    #[inline(always)]
    pub fn pcswtrg(&mut self) -> PcswtrgW<'_, Ctrl2Spec> {
        PcswtrgW::new(self, 21)
    }
    #[doc = "Bit 22 - Conversion trigger by software of ordinary channels"]
    #[inline(always)]
    pub fn ocswtrg(&mut self) -> OcswtrgW<'_, Ctrl2Spec> {
        OcswtrgW::new(self, 22)
    }
    #[doc = "Bit 23 - Internal temperature sensor and VINTRV enable"]
    #[inline(always)]
    pub fn itsrven(&mut self) -> ItsrvenW<'_, Ctrl2Spec> {
