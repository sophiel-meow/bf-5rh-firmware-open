...
impl W {
    #[doc = "Bits 0:11 - Data offset for Preempted channel 4"]
    #[inline(always)]
    pub fn pcdto4(&mut self) -> Pcdto4W<'_, Pcdto4Spec> {
        Pcdto4W::new(self, 0)
    }
}
#[doc = "Preempted channel 4 data offset register\n\nYou can [`read`](crate::Reg::read) this register and get [`pcdto4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcdto4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
