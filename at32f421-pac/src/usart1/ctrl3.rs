...
impl W {
    ...
    #[doc = "Bit 1 - IrDA enable"]
    #[inline(always)]
    pub fn irdaen(&mut self) -> IrdaenW<'_, Ctrl3Spec> {
        IrdaenW::new(self, 1)
    }
    #[doc = "Bit 2 - IrDA low-power mode"]
    #[inline(always)]
    pub fn irdalp(&mut self) -> IrdalpW<'_, Ctrl3Spec> {
        IrdalpW::new(self, 2)
    }
    #[doc = "Bit 3 - Single line bidirectional half-duplex enable"]
    #[inline(always)]
    pub fn slben(&mut self) -> SlbenW<'_, Ctrl3Spec> {
        SlbenW::new(self, 3)
    }
    #[doc = "Bit 4 - Smartcard NACK enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - Smartcard mode enable"]
    #[inline(always)]
    pub fn scmen(&mut self) -> ScmenW<'_, Ctrl3Spec> {
        ScmenW::new(self, 5)
    }
    #[doc = "Bit 6 - DMA receiver enable"]
    #[inline(always)]
    pub fn dmaren(&mut self) -> DmarenW<'_, Ctrl3Spec> {
        DmarenW::new(self, 6)
    }
    #[doc = "Bit 7 - DMA transmitter enable"]
    #[inline(always)]
    pub fn dmaten(&mut self) -> DmatenW<'_, Ctrl3Spec> {
        DmatenW::new(self, 7)
    }
    #[doc = "Bit 8 - RTS enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 10 - CTSCF interrupt enable"]
    #[inline(always)]
    pub fn ctscfien(&mut self) -> CtscfienW<'_, Ctrl3Spec> {
