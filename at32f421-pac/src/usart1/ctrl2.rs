...
impl W {
    #[doc = "Bits 0:3 - USART identification"]
    #[inline(always)]
    pub fn id(&mut self) -> IdW<'_, Ctrl2Spec> {
        IdW::new(self, 0)
    }
    #[doc = "Bit 5 - Break frame bit num"]
    #[inline(always)]
    pub fn bfbn(&mut self) -> BfbnW<'_, Ctrl2Spec> {
        BfbnW::new(self, 5)
    }
    #[doc = "Bit 6 - Break frame interrupt enable"]
    #[inline(always)]
    pub fn bfien(&mut self) -> BfienW<'_, Ctrl2Spec> {
        BfienW::new(self, 6)
    }
    #[doc = "Bit 8 - Last bit clock pulse"]
    #[inline(always)]
    pub fn lbcp(&mut self) -> LbcpW<'_, Ctrl2Spec> {
        LbcpW::new(self, 8)
    }
    #[doc = "Bit 9 - Clock phase"]
    #[inline(always)]
    ...
    #[doc = "Bits 12:13 - STOP bit num"]
    #[inline(always)]
    pub fn stopbn(&mut self) -> StopbnW<'_, Ctrl2Spec> {
        StopbnW::new(self, 12)
    }
    #[doc = "Bit 14 - LIN mode enable"]
    #[inline(always)]
    pub fn linen(&mut self) -> LinenW<'_, Ctrl2Spec> {
        LinenW::new(self, 14)
    }
    #[doc = "Bit 15 - Transmit receive pin swap"]
    #[inline(always)]
    pub fn trpswap(&mut self) -> TrpswapW<'_, Ctrl2Spec> {
