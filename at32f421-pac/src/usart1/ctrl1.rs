...
pub type DbnR = crate::BitReader;
#[doc = "Field `DBN` writer - Data bit num"]
pub type DbnW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn dbn(&self) -> DbnR {
        DbnR::new(((self.bits >> 12) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - Send break frame"]
    #[inline(always)]
    pub fn sbf(&mut self) -> SbfW<'_, Ctrl1Spec> {
        SbfW::new(self, 0)
    }
    #[doc = "Bit 1 - Receiver mute"]
    #[inline(always)]
    pub fn rm(&mut self) -> RmW<'_, Ctrl1Spec> {
        RmW::new(self, 1)
    }
    #[doc = "Bit 2 - Receiver enable"]
    #[inline(always)]
    pub fn ren(&mut self) -> RenW<'_, Ctrl1Spec> {
        RenW::new(self, 2)
    }
    #[doc = "Bit 3 - Transmitter enable"]
    #[inline(always)]
    pub fn ten(&mut self) -> TenW<'_, Ctrl1Spec> {
        TenW::new(self, 3)
    }
    #[doc = "Bit 4 - IDLE interrupt enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - RDBF interrupt enable"]
    #[inline(always)]
    pub fn rdbfien(&mut self) -> RdbfienW<'_, Ctrl1Spec> {
        RdbfienW::new(self, 5)
    }
    #[doc = "Bit 6 - TDC interrupt enable"]
    #[inline(always)]
    pub fn tdcien(&mut self) -> TdcienW<'_, Ctrl1Spec> {
        TdcienW::new(self, 6)
    }
    #[doc = "Bit 7 - TDBE interrupt enable"]
    #[inline(always)]
    pub fn tdbeien(&mut self) -> TdbeienW<'_, Ctrl1Spec> {
        TdbeienW::new(self, 7)
    }
    #[doc = "Bit 8 - PERR interrupt enable"]
    #[inline(always)]
    pub fn perrien(&mut self) -> PerrienW<'_, Ctrl1Spec> {
        PerrienW::new(self, 8)
    }
    #[doc = "Bit 9 - Parity selection"]
    #[inline(always)]
    pub fn psel(&mut self) -> PselW<'_, Ctrl1Spec> {
        PselW::new(self, 9)
    }
    #[doc = "Bit 10 - Parity enable"]
    #[inline(always)]
    pub fn pen(&mut self) -> PenW<'_, Ctrl1Spec> {
        PenW::new(self, 10)
    }
    #[doc = "Bit 11 - Wake up mode"]
    #[inline(always)]
    pub fn wum(&mut self) -> WumW<'_, Ctrl1Spec> {
        WumW::new(self, 11)
    }
    #[doc = "Bit 12 - Data bit num"]
    #[inline(always)]
    pub fn dbn(&mut self) -> DbnW<'_, Ctrl1Spec> {
        DbnW::new(self, 12)
    }
    #[doc = "Bit 13 - USART enable"]
    #[inline(always)]
