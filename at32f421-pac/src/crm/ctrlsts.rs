...
impl W {
    #[doc = "Bit 0 - Low speed internal clock enable"]
    #[inline(always)]
    pub fn licken(&mut self) -> LickenW<'_, CtrlstsSpec> {
        LickenW::new(self, 0)
    }
    #[doc = "Bit 24 - Reset flag clear"]
    #[inline(always)]
    pub fn rstfc(&mut self) -> RstfcW<'_, CtrlstsSpec> {
        RstfcW::new(self, 24)
    }
    #[doc = "Bit 26 - PIN reset flag"]
    #[inline(always)]
    pub fn nrstf(&mut self) -> NrstfW<'_, CtrlstsSpec> {
        NrstfW::new(self, 26)
    }
    #[doc = "Bit 27 - POR/LVR reset flag"]
    #[inline(always)]
    pub fn porrstf(&mut self) -> PorrstfW<'_, CtrlstsSpec> {
        PorrstfW::new(self, 27)
    }
    #[doc = "Bit 28 - Software reset flag"]
    #[inline(always)]
    pub fn swrstf(&mut self) -> SwrstfW<'_, CtrlstsSpec> {
        SwrstfW::new(self, 28)
    }
    #[doc = "Bit 29 - Watchdog timer reset flag"]
    #[inline(always)]
    pub fn wdtrstf(&mut self) -> WdtrstfW<'_, CtrlstsSpec> {
        WdtrstfW::new(self, 29)
    }
    #[doc = "Bit 30 - Window watchdog timer reset flag"]
    #[inline(always)]
    pub fn wwdtrstf(&mut self) -> WwdtrstfW<'_, CtrlstsSpec> {
        WwdtrstfW::new(self, 30)
    }
    #[doc = "Bit 31 - Low-power reset flag"]
    #[inline(always)]
    pub fn lprstf(&mut self) -> LprstfW<'_, CtrlstsSpec> {
        LprstfW::new(self, 31)
    }
}
