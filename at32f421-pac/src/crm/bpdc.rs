...
impl W {
    #[doc = "Bit 0 - Low speed external crystal enable"]
    #[inline(always)]
    pub fn lexten(&mut self) -> LextenW<'_, BpdcSpec> {
        LextenW::new(self, 0)
    }
    #[doc = "Bit 2 - Low speed external crystal bypass"]
    #[inline(always)]
    pub fn lextbyps(&mut self) -> LextbypsW<'_, BpdcSpec> {
        LextbypsW::new(self, 2)
    }
    #[doc = "Bits 8:9 - ERTC clock selection"]
    #[inline(always)]
    pub fn ertcsel(&mut self) -> ErtcselW<'_, BpdcSpec> {
        ErtcselW::new(self, 8)
    }
    #[doc = "Bit 15 - ERTC clock enable"]
    #[inline(always)]
    pub fn ertcen(&mut self) -> ErtcenW<'_, BpdcSpec> {
        ErtcenW::new(self, 15)
    }
    #[doc = "Bit 16 - Battery powered domain software reset"]
    #[inline(always)]
    pub fn bpdrst(&mut self) -> BpdrstW<'_, BpdcSpec> {
        BpdrstW::new(self, 16)
    }
}
