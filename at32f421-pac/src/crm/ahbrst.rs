...
impl W {
    #[doc = "Bit 17 - IO port A reset"]
    #[inline(always)]
    pub fn gpioarst(&mut self) -> GpioarstW<'_, AhbrstSpec> {
        GpioarstW::new(self, 17)
    }
    #[doc = "Bit 18 - IO port B reset"]
    #[inline(always)]
    pub fn gpiobrst(&mut self) -> GpiobrstW<'_, AhbrstSpec> {
        GpiobrstW::new(self, 18)
    }
    #[doc = "Bit 19 - IO port C reset"]
    #[inline(always)]
    pub fn gpiocrst(&mut self) -> GpiocrstW<'_, AhbrstSpec> {
        GpiocrstW::new(self, 19)
    }
    #[doc = "Bit 22 - IO port F reset"]
    #[inline(always)]
    pub fn gpiofrst(&mut self) -> GpiofrstW<'_, AhbrstSpec> {
