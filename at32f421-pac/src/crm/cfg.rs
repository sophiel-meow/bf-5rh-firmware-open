...
impl W {
    #[doc = "Bits 0:1 - System clock select"]
    #[inline(always)]
    pub fn sclksel(&mut self) -> SclkselW<'_, CfgSpec> {
        SclkselW::new(self, 0)
    }
    #[doc = "Bits 4:7 - AHB division"]
    #[inline(always)]
    pub fn ahbdiv(&mut self) -> AhbdivW<'_, CfgSpec> {
        AhbdivW::new(self, 4)
    }
    #[doc = "Bits 8:10 - APB1 division"]
    #[inline(always)]
    pub fn apb1div(&mut self) -> Apb1divW<'_, CfgSpec> {
        Apb1divW::new(self, 8)
    }
    #[doc = "Bits 11:13 - APB2 division"]
    #[inline(always)]
    pub fn apb2div(&mut self) -> Apb2divW<'_, CfgSpec> {
        Apb2divW::new(self, 11)
    }
    #[doc = "Bits 14:15 - ADC division bit1 and bit0"]
    #[inline(always)]
    pub fn adcdiv1_0(&mut self) -> Adcdiv1_0W<'_, CfgSpec> {
        Adcdiv1_0W::new(self, 14)
    }
    #[doc = "Bit 16 - PLL reference clock select"]
    #[inline(always)]
    pub fn pllrcs(&mut self) -> PllrcsW<'_, CfgSpec> {
        PllrcsW::new(self, 16)
    }
    #[doc = "Bit 17 - HEXT division selection for PLL entry clock"]
    #[inline(always)]
    pub fn pllhextdiv(&mut self) -> PllhextdivW<'_, CfgSpec> {
        PllhextdivW::new(self, 17)
    }
    #[doc = "Bits 18:21 - PLL Multiplication Factor bit3 to bit0"]
    #[inline(always)]
    pub fn pllmult3_0(&mut self) -> Pllmult3_0W<'_, CfgSpec> {
        Pllmult3_0W::new(self, 18)
    }
    #[doc = "Bits 24:26 - Clock output selection bit2 to bit0"]
    #[inline(always)]
    pub fn clkout_sel(&mut self) -> ClkoutSelW<'_, CfgSpec> {
        ClkoutSelW::new(self, 24)
    }
    #[doc = "Bit 28 - ADC division bit2"]
    #[inline(always)]
    pub fn adcdiv2(&mut self) -> Adcdiv2W<'_, CfgSpec> {
        Adcdiv2W::new(self, 28)
    }
    #[doc = "Bits 29:30 - PLL Multiplication Factor bit5 and bit4"]
    #[inline(always)]
    pub fn pllmult5_4(&mut self) -> Pllmult5_4W<'_, CfgSpec> {
