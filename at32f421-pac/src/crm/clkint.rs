...
impl W {
    #[doc = "Bit 8 - LICK ready interrupt enable"]
    #[inline(always)]
    pub fn lickstblien(&mut self) -> LickstblienW<'_, ClkintSpec> {
        LickstblienW::new(self, 8)
    }
    #[doc = "Bit 9 - LEXT ready interrupt enable"]
    #[inline(always)]
    pub fn lextstblien(&mut self) -> LextstblienW<'_, ClkintSpec> {
        LextstblienW::new(self, 9)
    }
    #[doc = "Bit 10 - HICK ready interrupt enable"]
    #[inline(always)]
    pub fn hickstblien(&mut self) -> HickstblienW<'_, ClkintSpec> {
        HickstblienW::new(self, 10)
    }
    #[doc = "Bit 11 - HEXT ready interrupt enable"]
    #[inline(always)]
    pub fn hextstblien(&mut self) -> HextstblienW<'_, ClkintSpec> {
        HextstblienW::new(self, 11)
    }
    #[doc = "Bit 12 - PLL ready interrupt enable"]
    #[inline(always)]
    pub fn pllstblien(&mut self) -> PllstblienW<'_, ClkintSpec> {
        PllstblienW::new(self, 12)
    }
    #[doc = "Bit 16 - LICK ready interrupt clear"]
    #[inline(always)]
    pub fn lickstblfc(&mut self) -> LickstblfcW<'_, ClkintSpec> {
        LickstblfcW::new(self, 16)
    }
    #[doc = "Bit 17 - LEXT ready interrupt clear"]
    #[inline(always)]
    pub fn lextstblfc(&mut self) -> LextstblfcW<'_, ClkintSpec> {
        LextstblfcW::new(self, 17)
    }
    #[doc = "Bit 18 - HICK ready interrupt clear"]
    #[inline(always)]
    pub fn hickstblfc(&mut self) -> HickstblfcW<'_, ClkintSpec> {
        HickstblfcW::new(self, 18)
    }
    #[doc = "Bit 19 - HEXT ready interrupt clear"]
    #[inline(always)]
    pub fn hextstblfc(&mut self) -> HextstblfcW<'_, ClkintSpec> {
        HextstblfcW::new(self, 19)
    }
    #[doc = "Bit 20 - PLL ready interrupt clear"]
    #[inline(always)]
    pub fn pllstblfc(&mut self) -> PllstblfcW<'_, ClkintSpec> {
        PllstblfcW::new(self, 20)
    }
    #[doc = "Bit 23 - Clock failure detection interrupt clear"]
    #[inline(always)]
    pub fn cfdfc(&mut self) -> CfdfcW<'_, ClkintSpec> {
        CfdfcW::new(self, 23)
    }
}
