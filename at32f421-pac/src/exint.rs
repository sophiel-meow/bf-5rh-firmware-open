...
pub mod evten;
#[doc = "POLCFG1 (rw) register accessor: Rising polarity configuration register(EXTINT_POLCFG1)\n\nYou can [`read`](crate::Reg::read) this register and get [`polcfg1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`polcfg1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@polcfg1`] module"]
#[doc(alias = "POLCFG1")]
pub type Polcfg1 = crate::Reg<polcfg1::Polcfg1Spec>;
#[doc = "Rising polarity configuration register(EXTINT_POLCFG1)"]
pub mod polcfg1;
#[doc = "POLCFG2 (rw) register accessor: Falling polarity configuration register(EXTINT_POLCFG2)\n\nYou can [`read`](crate::Reg::read) this register and get [`polcfg2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`polcfg2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@polcfg2`] module"]
#[doc(alias = "POLCFG2")]
