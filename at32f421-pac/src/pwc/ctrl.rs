...
impl W {
    #[doc = "Bit 0 - Voltage regulator state select when deepsleep mode"]
    #[inline(always)]
    pub fn vrsel(&mut self) -> VrselW<'_, CtrlSpec> {
        VrselW::new(self, 0)
    }
    #[doc = "Bit 1 - Low power mode select when Cortex-M4F sleepdeep"]
    #[inline(always)]
    pub fn lpsel(&mut self) -> LpselW<'_, CtrlSpec> {
        LpselW::new(self, 1)
    }
    #[doc = "Bit 2 - Clear SWEF flag"]
    #[inline(always)]
    pub fn clswef(&mut self) -> ClswefW<'_, CtrlSpec> {
        ClswefW::new(self, 2)
    }
    #[doc = "Bit 3 - Clear SEF flag"]
    #[inline(always)]
    pub fn clsef(&mut self) -> ClsefW<'_, CtrlSpec> {
        ClsefW::new(self, 3)
    }
    #[doc = "Bit 4 - Power voltage monitoring enable"]
    #[inline(always)]
    pub fn pvmen(&mut self) -> PvmenW<'_, CtrlSpec> {
        PvmenW::new(self, 4)
    }
    #[doc = "Bits 5:7 - Power voltage monitoring boundary select"]
    #[inline(always)]
    pub fn pvmsel(&mut self) -> PvmselW<'_, CtrlSpec> {
        PvmselW::new(self, 5)
    }
    #[doc = "Bit 8 - Battery powered domain write enable"]
    #[inline(always)]
    pub fn bpwen(&mut self) -> BpwenW<'_, CtrlSpec> {
        BpwenW::new(self, 8)
    }
}
