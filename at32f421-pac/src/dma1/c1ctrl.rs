#[doc = "Register `C1CTRL` reader"]
pub type R = crate::R<C1ctrlSpec>;
#[doc = "Register `C1CTRL` writer"]
pub type W = crate::W<C1ctrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Channel enable"]
    #[inline(always)]
    pub fn chen(&mut self) -> ChenW<'_, C1ctrlSpec> {
        ChenW::new(self, 0)
    }
    #[doc = "Bit 1 - Full data transfer interrupt enable"]
    #[inline(always)]
    pub fn fdtien(&mut self) -> FdtienW<'_, C1ctrlSpec> {
        FdtienW::new(self, 1)
    }
    #[doc = "Bit 2 - Half data transfer interrupt enable"]
    #[inline(always)]
    pub fn hdtien(&mut self) -> HdtienW<'_, C1ctrlSpec> {
        HdtienW::new(self, 2)
    }
    #[doc = "Bit 3 - Data transfer error interrupt enable"]
    #[inline(always)]
    pub fn dterrien(&mut self) -> DterrienW<'_, C1ctrlSpec> {
        DterrienW::new(self, 3)
    }
    #[doc = "Bit 4 - Data transfer direction"]
    #[inline(always)]
    pub fn dtd(&mut self) -> DtdW<'_, C1ctrlSpec> {
        DtdW::new(self, 4)
    }
    #[doc = "Bit 5 - Loop mode"]
    #[inline(always)]
    pub fn lm(&mut self) -> LmW<'_, C1ctrlSpec> {
        LmW::new(self, 5)
    }
    #[doc = "Bit 6 - Peripheral address increment mode"]
    #[inline(always)]
    pub fn pincm(&mut self) -> PincmW<'_, C1ctrlSpec> {
        PincmW::new(self, 6)
    }
    #[doc = "Bit 7 - Memory address increment mode"]
    #[inline(always)]
    pub fn mincm(&mut self) -> MincmW<'_, C1ctrlSpec> {
        MincmW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Peripheral data bit width"]
    #[inline(always)]
    pub fn pwidth(&mut self) -> PwidthW<'_, C1ctrlSpec> {
        PwidthW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Memory data bit width"]
    #[inline(always)]
    pub fn mwidth(&mut self) -> MwidthW<'_, C1ctrlSpec> {
        MwidthW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Channel Priority level"]
    #[inline(always)]
    pub fn chpl(&mut self) -> ChplW<'_, C1ctrlSpec> {
        ChplW::new(self, 12)
    }
    #[doc = "Bit 14 - Memory to memory mode"]
    #[inline(always)]
    pub fn m2m(&mut self) -> M2mW<'_, C1ctrlSpec> {
        M2mW::new(self, 14)
    }
}
#[doc = "DMA channel configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`c1ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c1ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C1ctrlSpec;
impl crate::RegisterSpec for C1ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c1ctrl::R`](R) reader structure"]
impl crate::Readable for C1ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`c1ctrl::W`](W) writer structure"]
impl crate::Writable for C1ctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C1CTRL to value 0"]
impl crate::Resettable for C1ctrlSpec {}
