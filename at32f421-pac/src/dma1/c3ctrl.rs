#[doc = "Register `C3CTRL` reader"]
pub type R = crate::R<C3ctrlSpec>;
#[doc = "Register `C3CTRL` writer"]
pub type W = crate::W<C3ctrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Channel enable"]
    #[inline(always)]
    pub fn chen(&mut self) -> ChenW<'_, C3ctrlSpec> {
        ChenW::new(self, 0)
    }
    #[doc = "Bit 1 - Full data transfer interrupt enable"]
    #[inline(always)]
    pub fn fdtien(&mut self) -> FdtienW<'_, C3ctrlSpec> {
        FdtienW::new(self, 1)
    }
    #[doc = "Bit 2 - Half data transfer interrupt enable"]
    #[inline(always)]
    pub fn hdtien(&mut self) -> HdtienW<'_, C3ctrlSpec> {
        HdtienW::new(self, 2)
    }
    #[doc = "Bit 3 - Data transfer error interrupt enable"]
    #[inline(always)]
    pub fn dterrien(&mut self) -> DterrienW<'_, C3ctrlSpec> {
        DterrienW::new(self, 3)
    }
    #[doc = "Bit 4 - Data transfer direction"]
    #[inline(always)]
    pub fn dtd(&mut self) -> DtdW<'_, C3ctrlSpec> {
        DtdW::new(self, 4)
    }
    #[doc = "Bit 5 - Loop mode"]
    #[inline(always)]
    pub fn lm(&mut self) -> LmW<'_, C3ctrlSpec> {
        LmW::new(self, 5)
    }
    #[doc = "Bit 6 - Peripheral address increment mode"]
    #[inline(always)]
    pub fn pincm(&mut self) -> PincmW<'_, C3ctrlSpec> {
        PincmW::new(self, 6)
    }
    #[doc = "Bit 7 - Memory address increment mode"]
    #[inline(always)]
    pub fn mincm(&mut self) -> MincmW<'_, C3ctrlSpec> {
        MincmW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Peripheral data bit width"]
    #[inline(always)]
    pub fn pwidth(&mut self) -> PwidthW<'_, C3ctrlSpec> {
        PwidthW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Memory data bit width"]
    #[inline(always)]
    pub fn mwidth(&mut self) -> MwidthW<'_, C3ctrlSpec> {
        MwidthW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Channel Priority level"]
    #[inline(always)]
    pub fn chpl(&mut self) -> ChplW<'_, C3ctrlSpec> {
        ChplW::new(self, 12)
    }
    #[doc = "Bit 14 - Memory to memory mode"]
    #[inline(always)]
    pub fn m2m(&mut self) -> M2mW<'_, C3ctrlSpec> {
        M2mW::new(self, 14)
    }
}
#[doc = "DMA channel configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`c3ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c3ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C3ctrlSpec;
impl crate::RegisterSpec for C3ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c3ctrl::R`](R) reader structure"]
impl crate::Readable for C3ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`c3ctrl::W`](W) writer structure"]
impl crate::Writable for C3ctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C3CTRL to value 0"]
impl crate::Resettable for C3ctrlSpec {}
