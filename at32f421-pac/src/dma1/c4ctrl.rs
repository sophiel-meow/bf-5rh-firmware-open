#[doc = "Register `C4CTRL` reader"]
pub type R = crate::R<C4ctrlSpec>;
#[doc = "Register `C4CTRL` writer"]
pub type W = crate::W<C4ctrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Channel enable"]
    #[inline(always)]
    pub fn chen(&mut self) -> ChenW<'_, C4ctrlSpec> {
        ChenW::new(self, 0)
    }
    #[doc = "Bit 1 - Full data transfer interrupt enable"]
    #[inline(always)]
    pub fn fdtien(&mut self) -> FdtienW<'_, C4ctrlSpec> {
        FdtienW::new(self, 1)
    }
    #[doc = "Bit 2 - Half data transfer interrupt enable"]
    #[inline(always)]
    pub fn hdtien(&mut self) -> HdtienW<'_, C4ctrlSpec> {
        HdtienW::new(self, 2)
    }
    #[doc = "Bit 3 - Data transfer error interrupt enable"]
    #[inline(always)]
    pub fn dterrien(&mut self) -> DterrienW<'_, C4ctrlSpec> {
        DterrienW::new(self, 3)
    }
    #[doc = "Bit 4 - Data transfer direction"]
    #[inline(always)]
    pub fn dtd(&mut self) -> DtdW<'_, C4ctrlSpec> {
        DtdW::new(self, 4)
    }
    #[doc = "Bit 5 - Loop mode"]
    #[inline(always)]
    pub fn lm(&mut self) -> LmW<'_, C4ctrlSpec> {
        LmW::new(self, 5)
    }
    #[doc = "Bit 6 - Peripheral address increment mode"]
    #[inline(always)]
    pub fn pincm(&mut self) -> PincmW<'_, C4ctrlSpec> {
        PincmW::new(self, 6)
    }
    #[doc = "Bit 7 - Memory address increment mode"]
    #[inline(always)]
    pub fn mincm(&mut self) -> MincmW<'_, C4ctrlSpec> {
        MincmW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Peripheral data bit width"]
    #[inline(always)]
    pub fn pwidth(&mut self) -> PwidthW<'_, C4ctrlSpec> {
        PwidthW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Memory data bit width"]
    #[inline(always)]
    pub fn mwidth(&mut self) -> MwidthW<'_, C4ctrlSpec> {
        MwidthW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Channel Priority level"]
    #[inline(always)]
    pub fn chpl(&mut self) -> ChplW<'_, C4ctrlSpec> {
        ChplW::new(self, 12)
    }
    #[doc = "Bit 14 - Memory to memory mode"]
    #[inline(always)]
    pub fn m2m(&mut self) -> M2mW<'_, C4ctrlSpec> {
        M2mW::new(self, 14)
    }
}
#[doc = "DMA channel configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`c4ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c4ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C4ctrlSpec;
impl crate::RegisterSpec for C4ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c4ctrl::R`](R) reader structure"]
impl crate::Readable for C4ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`c4ctrl::W`](W) writer structure"]
impl crate::Writable for C4ctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C4CTRL to value 0"]
impl crate::Resettable for C4ctrlSpec {}
