...
impl W {
    #[doc = "Bits 0:3 - GPIOx pin 0 muxing"]
    #[inline(always)]
    pub fn muxl0(&mut self) -> Muxl0W<'_, MuxlSpec> {
        Muxl0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - GPIOx pin 1 muxing"]
    #[inline(always)]
    pub fn muxl1(&mut self) -> Muxl1W<'_, MuxlSpec> {
        Muxl1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - GPIOx pin 2 muxing"]
    #[inline(always)]
    pub fn muxl2(&mut self) -> Muxl2W<'_, MuxlSpec> {
        Muxl2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - GPIOx pin 3 muxing"]
    #[inline(always)]
    pub fn muxl3(&mut self) -> Muxl3W<'_, MuxlSpec> {
        Muxl3W::new(self, 12)
    }
    #[doc = "Bits 16:19 - GPIOx pin 4 muxing"]
    #[inline(always)]
    pub fn muxl4(&mut self) -> Muxl4W<'_, MuxlSpec> {
        Muxl4W::new(self, 16)
    }
    #[doc = "Bits 20:23 - GPIOx pin 5 muxing"]
    #[inline(always)]
    pub fn muxl5(&mut self) -> Muxl5W<'_, MuxlSpec> {
        Muxl5W::new(self, 20)
    }
    #[doc = "Bits 24:27 - GPIOx pin 6 muxing"]
    #[inline(always)]
    pub fn muxl6(&mut self) -> Muxl6W<'_, MuxlSpec> {
        Muxl6W::new(self, 24)
    }
    #[doc = "Bits 28:31 - GPIOx pin 7 muxing"]
    #[inline(always)]
    pub fn muxl7(&mut self) -> Muxl7W<'_, MuxlSpec> {
        Muxl7W::new(self, 28)
    }
}
