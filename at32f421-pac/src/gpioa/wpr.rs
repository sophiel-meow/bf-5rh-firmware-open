...
impl W {
    #[doc = "Bit 0 - Write protect enable 0"]
    #[inline(always)]
    pub fn wpen0(&mut self) -> Wpen0W<'_, WprSpec> {
        Wpen0W::new(self, 0)
    }
    #[doc = "Bit 1 - Write protect enable 1"]
    #[inline(always)]
    pub fn wpen1(&mut self) -> Wpen1W<'_, WprSpec> {
        Wpen1W::new(self, 1)
    }
    #[doc = "Bit 2 - Write protect enable 2"]
    #[inline(always)]
    pub fn wpen2(&mut self) -> Wpen2W<'_, WprSpec> {
        Wpen2W::new(self, 2)
    }
    #[doc = "Bit 3 - Write protect enable 3"]
    #[inline(always)]
    pub fn wpen3(&mut self) -> Wpen3W<'_, WprSpec> {
        Wpen3W::new(self, 3)
    }
    #[doc = "Bit 4 - Write protect enable 4"]
    #[inline(always)]
    pub fn wpen4(&mut self) -> Wpen4W<'_, WprSpec> {
        Wpen4W::new(self, 4)
    }
    #[doc = "Bit 5 - Write protect enable 5"]
    #[inline(always)]
    pub fn wpen5(&mut self) -> Wpen5W<'_, WprSpec> {
        Wpen5W::new(self, 5)
    }
    #[doc = "Bit 6 - Write protect enable 6"]
    #[inline(always)]
    pub fn wpen6(&mut self) -> Wpen6W<'_, WprSpec> {
        Wpen6W::new(self, 6)
    }
    #[doc = "Bit 7 - Write protect enable 7"]
    #[inline(always)]
    pub fn wpen7(&mut self) -> Wpen7W<'_, WprSpec> {
        Wpen7W::new(self, 7)
    }
    #[doc = "Bit 8 - Write protect enable 8"]
    #[inline(always)]
    pub fn wpen8(&mut self) -> Wpen8W<'_, WprSpec> {
        Wpen8W::new(self, 8)
    }
    #[doc = "Bit 9 - Write protect enable 9"]
    #[inline(always)]
    pub fn wpen9(&mut self) -> Wpen9W<'_, WprSpec> {
        Wpen9W::new(self, 9)
    }
    #[doc = "Bit 10 - Write protect enable 10"]
    #[inline(always)]
    pub fn wpen10(&mut self) -> Wpen10W<'_, WprSpec> {
        Wpen10W::new(self, 10)
    }
    #[doc = "Bit 11 - Write protect enable 11"]
    #[inline(always)]
    pub fn wpen11(&mut self) -> Wpen11W<'_, WprSpec> {
        Wpen11W::new(self, 11)
    }
    #[doc = "Bit 12 - Write protect enable 12"]
    #[inline(always)]
    pub fn wpen12(&mut self) -> Wpen12W<'_, WprSpec> {
        Wpen12W::new(self, 12)
    }
    #[doc = "Bit 13 - Write protect enable 13"]
    #[inline(always)]
    pub fn wpen13(&mut self) -> Wpen13W<'_, WprSpec> {
        Wpen13W::new(self, 13)
    }
    #[doc = "Bit 14 - Write protect enable 14"]
    #[inline(always)]
    pub fn wpen14(&mut self) -> Wpen14W<'_, WprSpec> {
        Wpen14W::new(self, 14)
    }
    #[doc = "Bit 15 - Write protect enable 15"]
    #[inline(always)]
    pub fn wpen15(&mut self) -> Wpen15W<'_, WprSpec> {
        Wpen15W::new(self, 15)
    }
    #[doc = "Bit 16 - Write protect sequence"]
    #[inline(always)]
    pub fn wpseq(&mut self) -> WpseqW<'_, WprSpec> {
        WpseqW::new(self, 16)
    }
}
