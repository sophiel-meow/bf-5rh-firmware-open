...
impl W {
    #[doc = "Bits 0:1 - GPIOx pin 0 output drive capability"]
    #[inline(always)]
    pub fn odrv0(&mut self) -> Odrv0W<'_, OdrvrSpec> {
        Odrv0W::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIOx pin 1 output drive capability"]
    #[inline(always)]
    pub fn odrv1(&mut self) -> Odrv1W<'_, OdrvrSpec> {
        Odrv1W::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIOx pin 2 output drive capability"]
    #[inline(always)]
    pub fn odrv2(&mut self) -> Odrv2W<'_, OdrvrSpec> {
        Odrv2W::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIOx pin 3 output drive capability"]
    #[inline(always)]
    pub fn odrv3(&mut self) -> Odrv3W<'_, OdrvrSpec> {
        Odrv3W::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIOx pin 4 output drive capability"]
    #[inline(always)]
    pub fn odrv4(&mut self) -> Odrv4W<'_, OdrvrSpec> {
        Odrv4W::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIOx pin 5 output drive capability"]
    #[inline(always)]
    pub fn odrv5(&mut self) -> Odrv5W<'_, OdrvrSpec> {
        Odrv5W::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIOx pin 6 output drive capability"]
    #[inline(always)]
    pub fn odrv6(&mut self) -> Odrv6W<'_, OdrvrSpec> {
        Odrv6W::new(self, 12)
    }
    #[doc = "Bits 14:15 - GPIOx pin 7 output drive capability"]
    #[inline(always)]
    pub fn odrv7(&mut self) -> Odrv7W<'_, OdrvrSpec> {
        Odrv7W::new(self, 14)
    }
    #[doc = "Bits 16:17 - GPIOx pin 8 output drive capability"]
    #[inline(always)]
    pub fn odrv8(&mut self) -> Odrv8W<'_, OdrvrSpec> {
        Odrv8W::new(self, 16)
    }
    #[doc = "Bits 18:19 - GPIOx pin 9 output drive capability"]
    #[inline(always)]
    pub fn odrv9(&mut self) -> Odrv9W<'_, OdrvrSpec> {
        Odrv9W::new(self, 18)
    }
    #[doc = "Bits 20:21 - GPIOx pin 10 output drive capability"]
    #[inline(always)]
    pub fn odrv10(&mut self) -> Odrv10W<'_, OdrvrSpec> {
        Odrv10W::new(self, 20)
    }
    #[doc = "Bits 22:23 - GPIOx pin 11 output drive capability"]
    #[inline(always)]
    pub fn odrv11(&mut self) -> Odrv11W<'_, OdrvrSpec> {
        Odrv11W::new(self, 22)
    }
    #[doc = "Bits 24:25 - GPIOx pin 12 output drive capability"]
    #[inline(always)]
    pub fn odrv12(&mut self) -> Odrv12W<'_, OdrvrSpec> {
        Odrv12W::new(self, 24)
    }
    #[doc = "Bits 26:27 - GPIOx pin 13 output drive capability"]
    #[inline(always)]
    pub fn odrv13(&mut self) -> Odrv13W<'_, OdrvrSpec> {
        Odrv13W::new(self, 26)
    }
    #[doc = "Bits 28:29 - GPIOx pin 14 output drive capability"]
    #[inline(always)]
    pub fn odrv14(&mut self) -> Odrv14W<'_, OdrvrSpec> {
        Odrv14W::new(self, 28)
    }
    #[doc = "Bits 30:31 - GPIOx pin 15 output drive capability"]
    #[inline(always)]
    pub fn odrv15(&mut self) -> Odrv15W<'_, OdrvrSpec> {
        Odrv15W::new(self, 30)
    }
}
