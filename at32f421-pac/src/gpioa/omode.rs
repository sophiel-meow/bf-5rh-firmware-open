...
impl W {
    #[doc = "Bit 0 - GPIOx pin 0 outpu mode configurate"]
    #[inline(always)]
    pub fn om0(&mut self) -> Om0W<'_, OmodeSpec> {
        Om0W::new(self, 0)
    }
    #[doc = "Bit 1 - GPIOx pin 1 outpu mode configurate"]
    #[inline(always)]
    pub fn om1(&mut self) -> Om1W<'_, OmodeSpec> {
        Om1W::new(self, 1)
    }
    #[doc = "Bit 2 - GPIOx pin 2 outpu mode configurate"]
    #[inline(always)]
    pub fn om2(&mut self) -> Om2W<'_, OmodeSpec> {
        Om2W::new(self, 2)
    }
    #[doc = "Bit 3 - GPIOx pin 3 outpu mode configurate"]
    #[inline(always)]
    pub fn om3(&mut self) -> Om3W<'_, OmodeSpec> {
        Om3W::new(self, 3)
    }
    #[doc = "Bit 4 - GPIOx pin 4 outpu mode configurate"]
    #[inline(always)]
    pub fn om4(&mut self) -> Om4W<'_, OmodeSpec> {
        Om4W::new(self, 4)
    }
    #[doc = "Bit 5 - GPIOx pin 5 outpu mode configurate"]
    #[inline(always)]
    pub fn om5(&mut self) -> Om5W<'_, OmodeSpec> {
        Om5W::new(self, 5)
    }
    #[doc = "Bit 6 - GPIOx pin 6 outpu mode configurate"]
    #[inline(always)]
    pub fn om6(&mut self) -> Om6W<'_, OmodeSpec> {
        Om6W::new(self, 6)
    }
    #[doc = "Bit 7 - GPIOx pin 7 outpu mode configurate"]
    #[inline(always)]
    pub fn om7(&mut self) -> Om7W<'_, OmodeSpec> {
        Om7W::new(self, 7)
    }
    #[doc = "Bit 8 - GPIOx pin 8 outpu mode configurate"]
    #[inline(always)]
    pub fn om8(&mut self) -> Om8W<'_, OmodeSpec> {
        Om8W::new(self, 8)
    }
    #[doc = "Bit 9 - GPIOx pin 9 outpu mode configurate"]
    #[inline(always)]
    pub fn om9(&mut self) -> Om9W<'_, OmodeSpec> {
        Om9W::new(self, 9)
    }
    #[doc = "Bit 10 - GPIOx pin 10 outpu mode configurate"]
    #[inline(always)]
    pub fn om10(&mut self) -> Om10W<'_, OmodeSpec> {
        Om10W::new(self, 10)
    }
    #[doc = "Bit 11 - GPIOx pin 11 outpu mode configurate"]
    #[inline(always)]
    pub fn om11(&mut self) -> Om11W<'_, OmodeSpec> {
        Om11W::new(self, 11)
    }
    #[doc = "Bit 12 - GPIOx pin 12 outpu mode configurate"]
    #[inline(always)]
    pub fn om12(&mut self) -> Om12W<'_, OmodeSpec> {
        Om12W::new(self, 12)
    }
    #[doc = "Bit 13 - GPIOx pin 13 outpu mode configurate"]
    #[inline(always)]
    pub fn om13(&mut self) -> Om13W<'_, OmodeSpec> {
        Om13W::new(self, 13)
    }
    #[doc = "Bit 14 - GPIOx pin 14 outpu mode configurate"]
    #[inline(always)]
    pub fn om14(&mut self) -> Om14W<'_, OmodeSpec> {
        Om14W::new(self, 14)
    }
    #[doc = "Bit 15 - GPIOx pin 15 outpu mode configurate"]
    #[inline(always)]
    pub fn om15(&mut self) -> Om15W<'_, OmodeSpec> {
        Om15W::new(self, 15)
    }
}
