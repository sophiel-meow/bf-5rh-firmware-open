...
impl W {
    #[doc = "Bit 0 - Port output data"]
    #[inline(always)]
    pub fn odt0(&mut self) -> Odt0W<'_, OdtSpec> {
        Odt0W::new(self, 0)
    }
    #[doc = "Bit 1 - Port output data"]
    #[inline(always)]
    pub fn odt1(&mut self) -> Odt1W<'_, OdtSpec> {
        Odt1W::new(self, 1)
    }
    #[doc = "Bit 2 - Port output data"]
    #[inline(always)]
    pub fn odt2(&mut self) -> Odt2W<'_, OdtSpec> {
        Odt2W::new(self, 2)
    }
    #[doc = "Bit 3 - Port output data"]
    #[inline(always)]
    pub fn odt3(&mut self) -> Odt3W<'_, OdtSpec> {
        Odt3W::new(self, 3)
    }
    #[doc = "Bit 4 - Port output data"]
    #[inline(always)]
    pub fn odt4(&mut self) -> Odt4W<'_, OdtSpec> {
        Odt4W::new(self, 4)
    }
    #[doc = "Bit 5 - Port output data"]
    #[inline(always)]
    pub fn odt5(&mut self) -> Odt5W<'_, OdtSpec> {
        Odt5W::new(self, 5)
    }
    #[doc = "Bit 6 - Port output data"]
    #[inline(always)]
    pub fn odt6(&mut self) -> Odt6W<'_, OdtSpec> {
        Odt6W::new(self, 6)
    }
    #[doc = "Bit 7 - Port output data"]
    #[inline(always)]
    pub fn odt7(&mut self) -> Odt7W<'_, OdtSpec> {
        Odt7W::new(self, 7)
    }
    #[doc = "Bit 8 - Port output data"]
    #[inline(always)]
    pub fn odt8(&mut self) -> Odt8W<'_, OdtSpec> {
        Odt8W::new(self, 8)
    }
    #[doc = "Bit 9 - Port output data"]
    #[inline(always)]
    pub fn odt9(&mut self) -> Odt9W<'_, OdtSpec> {
        Odt9W::new(self, 9)
    }
    #[doc = "Bit 10 - Port output data"]
    #[inline(always)]
    pub fn odt10(&mut self) -> Odt10W<'_, OdtSpec> {
        Odt10W::new(self, 10)
    }
    #[doc = "Bit 11 - Port output data"]
    #[inline(always)]
    pub fn odt11(&mut self) -> Odt11W<'_, OdtSpec> {
        Odt11W::new(self, 11)
    }
    #[doc = "Bit 12 - Port output data"]
    #[inline(always)]
    pub fn odt12(&mut self) -> Odt12W<'_, OdtSpec> {
        Odt12W::new(self, 12)
    }
    #[doc = "Bit 13 - Port output data"]
    #[inline(always)]
    pub fn odt13(&mut self) -> Odt13W<'_, OdtSpec> {
        Odt13W::new(self, 13)
    }
    #[doc = "Bit 14 - Port output data"]
    #[inline(always)]
    pub fn odt14(&mut self) -> Odt14W<'_, OdtSpec> {
        Odt14W::new(self, 14)
    }
    #[doc = "Bit 15 - Port output data"]
    #[inline(always)]
    pub fn odt15(&mut self) -> Odt15W<'_, OdtSpec> {
        Odt15W::new(self, 15)
    }
}
