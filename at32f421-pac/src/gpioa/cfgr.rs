...
impl W {
    #[doc = "Bits 0:1 - GPIOx pin 0 mode configurate"]
    #[inline(always)]
    pub fn iomc0(&mut self) -> Iomc0W<'_, CfgrSpec> {
        Iomc0W::new(self, 0)
    }
    #[doc = "Bits 2:3 - GPIOx pin 1 mode configurate"]
    #[inline(always)]
    pub fn iomc1(&mut self) -> Iomc1W<'_, CfgrSpec> {
        Iomc1W::new(self, 2)
    }
    #[doc = "Bits 4:5 - GPIOx pin 2 mode configurate"]
    #[inline(always)]
    pub fn iomc2(&mut self) -> Iomc2W<'_, CfgrSpec> {
        Iomc2W::new(self, 4)
    }
    #[doc = "Bits 6:7 - GPIOx pin 3 mode configurate"]
    #[inline(always)]
    pub fn iomc3(&mut self) -> Iomc3W<'_, CfgrSpec> {
        Iomc3W::new(self, 6)
    }
    #[doc = "Bits 8:9 - GPIOx pin 4 mode configurate"]
    #[inline(always)]
    pub fn iomc4(&mut self) -> Iomc4W<'_, CfgrSpec> {
        Iomc4W::new(self, 8)
    }
    #[doc = "Bits 10:11 - GPIOx pin 5 mode configurate"]
    #[inline(always)]
    pub fn iomc5(&mut self) -> Iomc5W<'_, CfgrSpec> {
        Iomc5W::new(self, 10)
    }
    #[doc = "Bits 12:13 - GPIOx pin 6 mode configurate"]
    #[inline(always)]
    pub fn iomc6(&mut self) -> Iomc6W<'_, CfgrSpec> {
        Iomc6W::new(self, 12)
    }
    #[doc = "Bits 14:15 - GPIOx pin 7 mode configurate"]
    #[inline(always)]
    pub fn iomc7(&mut self) -> Iomc7W<'_, CfgrSpec> {
        Iomc7W::new(self, 14)
    }
    #[doc = "Bits 16:17 - GPIOx pin 8 mode configurate"]
    #[inline(always)]
    pub fn iomc8(&mut self) -> Iomc8W<'_, CfgrSpec> {
        Iomc8W::new(self, 16)
    }
    #[doc = "Bits 18:19 - GPIOx pin 9 mode configurate"]
    #[inline(always)]
    pub fn iomc9(&mut self) -> Iomc9W<'_, CfgrSpec> {
        Iomc9W::new(self, 18)
    }
    #[doc = "Bits 20:21 - GPIOx pin 10 mode configurate"]
    #[inline(always)]
    pub fn iomc10(&mut self) -> Iomc10W<'_, CfgrSpec> {
        Iomc10W::new(self, 20)
    }
    #[doc = "Bits 22:23 - GPIOx pin 11 mode configurate"]
    #[inline(always)]
    pub fn iomc11(&mut self) -> Iomc11W<'_, CfgrSpec> {
        Iomc11W::new(self, 22)
    }
    #[doc = "Bits 24:25 - GPIOx pin 12 mode configurate"]
    #[inline(always)]
    pub fn iomc12(&mut self) -> Iomc12W<'_, CfgrSpec> {
        Iomc12W::new(self, 24)
    }
    #[doc = "Bits 26:27 - GPIOx pin 13 mode configurate"]
    #[inline(always)]
    pub fn iomc13(&mut self) -> Iomc13W<'_, CfgrSpec> {
        Iomc13W::new(self, 26)
    }
    #[doc = "Bits 28:29 - GPIOx pin 14 mode configurate"]
    #[inline(always)]
    pub fn iomc14(&mut self) -> Iomc14W<'_, CfgrSpec> {
        Iomc14W::new(self, 28)
    }
    #[doc = "Bits 30:31 - GPIOx pin 15 mode configurate"]
    #[inline(always)]
    pub fn iomc15(&mut self) -> Iomc15W<'_, CfgrSpec> {
        Iomc15W::new(self, 30)
    }
}
