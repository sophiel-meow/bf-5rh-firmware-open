...
impl W {
    ...
    #[doc = "Bit 7 - Channel 1 output switch enable"]
    #[inline(always)]
    pub fn c1osen(&mut self) -> C1osenW<'_, Cm1OutputSpec> {
        C1osenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Channel 2 configure"]
    #[inline(always)]
    pub fn c2c(&mut self) -> C2cW<'_, Cm1OutputSpec> {
        C2cW::new(self, 8)
    }
    #[doc = "Bit 10 - Channel 2 output immediately enable"]
    #[inline(always)]
    pub fn c2oien(&mut self) -> C2oienW<'_, Cm1OutputSpec> {
        C2oienW::new(self, 10)
    }
    #[doc = "Bit 11 - Channel 2 output buffer enable"]
    #[inline(always)]
    pub fn c2oben(&mut self) -> C2obenW<'_, Cm1OutputSpec> {
        C2obenW::new(self, 11)
    }
    #[doc = "Bits 12:14 - Channel 2 output control"]
    #[inline(always)]
    pub fn c2octrl(&mut self) -> C2octrlW<'_, Cm1OutputSpec> {
        C2octrlW::new(self, 12)
    }
    #[doc = "Bit 15 - Channel 2 output switch enable"]
    #[inline(always)]
    pub fn c2osen(&mut self) -> C2osenW<'_, Cm1OutputSpec> {
        C2osenW::new(self, 15)
    }
}
