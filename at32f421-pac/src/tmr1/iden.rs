...
impl W {
    ...
    #[doc = "Bit 2 - Channel 2 interrupt enable"]
    #[inline(always)]
    pub fn c2ien(&mut self) -> C2ienW<'_, IdenSpec> {
        C2ienW::new(self, 2)
    }
    #[doc = "Bit 3 - Channel 3 interrupt enable"]
    #[inline(always)]
    pub fn c3ien(&mut self) -> C3ienW<'_, IdenSpec> {
        C3ienW::new(self, 3)
    }
    #[doc = "Bit 4 - Channel 4 interrupt enable"]
    #[inline(always)]
    pub fn c4ien(&mut self) -> C4ienW<'_, IdenSpec> {
        C4ienW::new(self, 4)
    }
    #[doc = "Bit 5 - HALL interrupt enable"]
    #[inline(always)]
    pub fn hallien(&mut self) -> HallienW<'_, IdenSpec> {
        HallienW::new(self, 5)
    }
    #[doc = "Bit 6 - Trigger interrupt enable"]
    #[inline(always)]
    pub fn tien(&mut self) -> TienW<'_, IdenSpec> {
        TienW::new(self, 6)
    }
    #[doc = "Bit 7 - Brake interrupt enable"]
    #[inline(always)]
    pub fn brkie(&mut self) -> BrkieW<'_, IdenSpec> {
        BrkieW::new(self, 7)
    }
    #[doc = "Bit 8 - Overflow DMA request enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - Channel 1 DMA request enable"]
    #[inline(always)]
    pub fn c1den(&mut self) -> C1denW<'_, IdenSpec> {
        C1denW::new(self, 9)
    }
    #[doc = "Bit 10 - Channel 2 DMA request enable"]
    #[inline(always)]
    pub fn c2den(&mut self) -> C2denW<'_, IdenSpec> {
        C2denW::new(self, 10)
    }
    #[doc = "Bit 11 - Channel 3 DMA request enable"]
    #[inline(always)]
    pub fn c3den(&mut self) -> C3denW<'_, IdenSpec> {
        C3denW::new(self, 11)
    }
    #[doc = "Bit 12 - Channel 4 DMA request enable"]
    #[inline(always)]
    pub fn c4den(&mut self) -> C4denW<'_, IdenSpec> {
        C4denW::new(self, 12)
    }
    #[doc = "Bit 13 - HALL DMA request enable"]
    #[inline(always)]
    pub fn hallde(&mut self) -> HalldeW<'_, IdenSpec> {
        HalldeW::new(self, 13)
    }
    #[doc = "Bit 14 - Trigger DMA request enable"]
    #[inline(always)]
    pub fn tden(&mut self) -> TdenW<'_, IdenSpec> {
        TdenW::new(self, 14)
    }
}
