...
impl W {
    ...
    #[doc = "Bit 7 - C1IN selection"]
    #[inline(always)]
    pub fn c1insel(&mut self) -> C1inselW<'_, Ctrl2Spec> {
        C1inselW::new(self, 7)
    }
    #[doc = "Bit 8 - Channel 1 idle output state"]
    #[inline(always)]
    ...
    #[doc = "Bit 10 - Channel 2 idle output state"]
    #[inline(always)]
    pub fn c2ios(&mut self) -> C2iosW<'_, Ctrl2Spec> {
        C2iosW::new(self, 10)
    }
    #[doc = "Bit 11 - Channel 2 complementary idle output state"]
    #[inline(always)]
    pub fn c2cios(&mut self) -> C2ciosW<'_, Ctrl2Spec> {
        C2ciosW::new(self, 11)
    }
    #[doc = "Bit 12 - Channel 3 idle output state"]
    #[inline(always)]
    pub fn c3ios(&mut self) -> C3iosW<'_, Ctrl2Spec> {
        C3iosW::new(self, 12)
    }
    #[doc = "Bit 13 - Channel 3 complementary idle output state"]
    #[inline(always)]
    pub fn c3cios(&mut self) -> C3ciosW<'_, Ctrl2Spec> {
        C3ciosW::new(self, 13)
    }
    #[doc = "Bit 14 - Channel 4 idle output state"]
    #[inline(always)]
    pub fn c4ios(&mut self) -> C4iosW<'_, Ctrl2Spec> {
        C4iosW::new(self, 14)
    }
}
