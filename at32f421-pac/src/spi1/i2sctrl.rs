...
impl W {
    #[doc = "Bit 0 - I2S channel bit num"]
    #[inline(always)]
    pub fn i2scbn(&mut self) -> I2scbnW<'_, I2sctrlSpec> {
        I2scbnW::new(self, 0)
    }
    #[doc = "Bits 1:2 - I2S data bit num"]
    #[inline(always)]
    pub fn i2sdbn(&mut self) -> I2sdbnW<'_, I2sctrlSpec> {
        I2sdbnW::new(self, 1)
    }
    #[doc = "Bit 3 - I2S clock polarity"]
    #[inline(always)]
    pub fn i2sclkpol(&mut self) -> I2sclkpolW<'_, I2sctrlSpec> {
        I2sclkpolW::new(self, 3)
    }
    #[doc = "Bits 4:5 - I2S standard select"]
    #[inline(always)]
    pub fn stdsel(&mut self) -> StdselW<'_, I2sctrlSpec> {
        StdselW::new(self, 4)
    }
    #[doc = "Bit 7 - PCM frame synchronization select"]
    #[inline(always)]
    pub fn pcmfssel(&mut self) -> PcmfsselW<'_, I2sctrlSpec> {
        PcmfsselW::new(self, 7)
    }
    #[doc = "Bits 8:9 - I2S operation select"]
    #[inline(always)]
    pub fn opersel(&mut self) -> OperselW<'_, I2sctrlSpec> {
        OperselW::new(self, 8)
    }
    #[doc = "Bit 10 - I2S Enable"]
    #[inline(always)]
    pub fn i2sen(&mut self) -> I2senW<'_, I2sctrlSpec> {
        I2senW::new(self, 10)
    }
    #[doc = "Bit 11 - I2S mode select"]
    #[inline(always)]
    pub fn i2smsel(&mut self) -> I2smselW<'_, I2sctrlSpec> {
