...
impl W {
    #[doc = "Bit 0 - DMA receive enable"]
    #[inline(always)]
    pub fn dmaren(&mut self) -> DmarenW<'_, Ctrl2Spec> {
        DmarenW::new(self, 0)
    }
    #[doc = "Bit 1 - DMA transmit enable"]
    #[inline(always)]
    pub fn dmaten(&mut self) -> DmatenW<'_, Ctrl2Spec> {
        DmatenW::new(self, 1)
    }
    #[doc = "Bit 2 - Hardware CS output enable"]
    #[inline(always)]
    pub fn hwcsoe(&mut self) -> HwcsoeW<'_, Ctrl2Spec> {
        HwcsoeW::new(self, 2)
    }
    #[doc = "Bit 5 - Error interrupt enable"]
    #[inline(always)]
    pub fn errie(&mut self) -> ErrieW<'_, Ctrl2Spec> {
        ErrieW::new(self, 5)
    }
    #[doc = "Bit 6 - Receive data buffer full interrupt enable"]
    #[inline(always)]
    pub fn rdbfie(&mut self) -> RdbfieW<'_, Ctrl2Spec> {
        RdbfieW::new(self, 6)
    }
    #[doc = "Bit 7 - Transmit data buffer empty interrupt enable"]
    #[inline(always)]
    pub fn tdbeie(&mut self) -> TdbeieW<'_, Ctrl2Spec> {
        TdbeieW::new(self, 7)
    }
    #[doc = "Bit 8 - Master clock frequency division bit3"]
    #[inline(always)]
    pub fn mdiv3(&mut self) -> Mdiv3W<'_, Ctrl2Spec> {
        Mdiv3W::new(self, 8)
    }
}
