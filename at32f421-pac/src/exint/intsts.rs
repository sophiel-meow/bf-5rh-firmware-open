...
pub type Line19R = crate::BitReader;
#[doc = "Field `LINE19` writer - Line 19 state bit"]
pub type Line19W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LINE21` reader - Line 21 state bit"]
pub type Line21R = crate::BitReader;
#[doc = "Field `LINE21` writer - Line 21 state bit"]
pub type Line21W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    #[doc = "Bit 0 - Line 0 state bit"]
    #[inline(always)]
    pub fn line0(&mut self) -> Line0W<'_, IntstsSpec> {
        Line0W::new(self, 0)
    }
    #[doc = "Bit 1 - Line 1 state bit"]
    #[inline(always)]
    pub fn line1(&mut self) -> Line1W<'_, IntstsSpec> {
        Line1W::new(self, 1)
    }
    #[doc = "Bit 2 - Line 2 state bit"]
    #[inline(always)]
    pub fn line2(&mut self) -> Line2W<'_, IntstsSpec> {
        Line2W::new(self, 2)
    }
    #[doc = "Bit 3 - Line 3 state bit"]
    #[inline(always)]
    pub fn line3(&mut self) -> Line3W<'_, IntstsSpec> {
        Line3W::new(self, 3)
    }
    #[doc = "Bit 4 - Line 4 state bit"]
    #[inline(always)]
    pub fn line4(&mut self) -> Line4W<'_, IntstsSpec> {
        Line4W::new(self, 4)
    }
    #[doc = "Bit 5 - Line 5 state bit"]
    #[inline(always)]
    pub fn line5(&mut self) -> Line5W<'_, IntstsSpec> {
        Line5W::new(self, 5)
    }
    #[doc = "Bit 6 - Line 6 state bit"]
    #[inline(always)]
    pub fn line6(&mut self) -> Line6W<'_, IntstsSpec> {
        Line6W::new(self, 6)
    }
    #[doc = "Bit 7 - Line 7 state bit"]
    #[inline(always)]
    pub fn line7(&mut self) -> Line7W<'_, IntstsSpec> {
        Line7W::new(self, 7)
    }
    #[doc = "Bit 8 - Line 8 state bit"]
    #[inline(always)]
    pub fn line8(&mut self) -> Line8W<'_, IntstsSpec> {
        Line8W::new(self, 8)
    }
    #[doc = "Bit 9 - Line 9 state bit"]
    #[inline(always)]
    pub fn line9(&mut self) -> Line9W<'_, IntstsSpec> {
        Line9W::new(self, 9)
    }
    #[doc = "Bit 10 - Line 10 state bit"]
    #[inline(always)]
    pub fn line10(&mut self) -> Line10W<'_, IntstsSpec> {
        Line10W::new(self, 10)
    }
    #[doc = "Bit 11 - Line 11 state bit"]
    #[inline(always)]
    pub fn line11(&mut self) -> Line11W<'_, IntstsSpec> {
        Line11W::new(self, 11)
    }
    #[doc = "Bit 12 - Line 12 state bit"]
    #[inline(always)]
    pub fn line12(&mut self) -> Line12W<'_, IntstsSpec> {
        Line12W::new(self, 12)
    }
    #[doc = "Bit 13 - Line 13 state bit"]
    #[inline(always)]
    pub fn line13(&mut self) -> Line13W<'_, IntstsSpec> {
        Line13W::new(self, 13)
    }
    #[doc = "Bit 14 - Line 14 state bit"]
    #[inline(always)]
    pub fn line14(&mut self) -> Line14W<'_, IntstsSpec> {
        Line14W::new(self, 14)
    }
    #[doc = "Bit 15 - Line 15 state bit"]
    #[inline(always)]
    pub fn line15(&mut self) -> Line15W<'_, IntstsSpec> {
        Line15W::new(self, 15)
    }
    #[doc = "Bit 16 - Line 16 state bit"]
    #[inline(always)]
    pub fn line16(&mut self) -> Line16W<'_, IntstsSpec> {
        Line16W::new(self, 16)
    }
    #[doc = "Bit 17 - Line 17 state bit"]
    #[inline(always)]
    pub fn line17(&mut self) -> Line17W<'_, IntstsSpec> {
        Line17W::new(self, 17)
    }
    #[doc = "Bit 19 - Line 19 state bit"]
    #[inline(always)]
    pub fn line19(&mut self) -> Line19W<'_, IntstsSpec> {
        Line19W::new(self, 19)
    }
    #[doc = "Bit 21 - Line 21 state bit"]
    #[inline(always)]
    pub fn line21(&mut self) -> Line21W<'_, IntstsSpec> {
        Line21W::new(self, 21)
    }
}
