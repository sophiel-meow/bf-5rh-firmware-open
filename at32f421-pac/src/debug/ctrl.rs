...
impl W {
    ...
    #[doc = "Bit 14 - ERTC_PAUSE"]
    #[inline(always)]
    pub fn ertc_pause(&mut self) -> ErtcPauseW<'_, CtrlSpec> {
    ...
    #[doc = "Bit 21 - ERTC_512_PAUSE"]
    #[inline(always)]
    pub fn ertc_512_pause(&mut self) -> Ertc512PauseW<'_, CtrlSpec> {
        Ertc512PauseW::new(self, 21)
    }
    #[doc = "Bit 22 - TMR15_PAUSE"]
    #[inline(always)]
    pub fn tmr15_pause(&mut self) -> Tmr15PauseW<'_, CtrlSpec> {
        Tmr15PauseW::new(self, 22)
    }
    #[doc = "Bit 23 - TMR16_PAUSE"]
    #[inline(always)]
    pub fn tmr16_pause(&mut self) -> Tmr16PauseW<'_, CtrlSpec> {
        Tmr16PauseW::new(self, 23)
    }
    #[doc = "Bit 24 - TMR17_PAUSE"]
    #[inline(always)]
    pub fn tmr17_pause(&mut self) -> Tmr17PauseW<'_, CtrlSpec> {
