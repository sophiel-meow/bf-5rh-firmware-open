...
impl W {
    #[doc = "Bit 0 - Boot memory store application code enabled flag"]
    #[inline(always)]
    pub fn btm_ap_enf(&mut self) -> BtmApEnfW<'_, SlibSts0Spec> {
        BtmApEnfW::new(self, 0)
    }
    #[doc = "Bit 2 - Extension memory sLib enabled flag"]
    #[inline(always)]
    pub fn em_slib_enf(&mut self) -> EmSlibEnfW<'_, SlibSts0Spec> {
        EmSlibEnfW::new(self, 2)
    }
    #[doc = "Bit 3 - sLib enabled flag"]
    #[inline(always)]
    pub fn slib_enf(&mut self) -> SlibEnfW<'_, SlibSts0Spec> {
        SlibEnfW::new(self, 3)
    }
    #[doc = "Bits 16:23 - Extension memory sLib instruction start sector"]
    #[inline(always)]
    pub fn em_slib_inst_ss(&mut self) -> EmSlibInstSsW<'_, SlibSts0Spec> {
