...
pub type FapHlDisR = crate::BitReader;
#[doc = "Field `FAP_HL_DIS` writer - FAP high level disable"]
pub type FapHlDisW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn fap_hl_dis(&self) -> FapHlDisR {
        FapHlDisR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Low power mode enable"]
    #[inline(always)]
    pub fn lpmen(&self) -> LpmenR {
        LpmenR::new(((self.bits >> 17) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Flash program"]
    #[inline(always)]
    pub fn fprgm(&mut self) -> FprgmW<'_, CtrlSpec> {
        FprgmW::new(self, 0)
    }
    #[doc = "Bit 1 - Sector erase"]
    #[inline(always)]
    pub fn secers(&mut self) -> SecersW<'_, CtrlSpec> {
        SecersW::new(self, 1)
    }
    #[doc = "Bit 2 - Bank erase"]
    #[inline(always)]
    pub fn bankers(&mut self) -> BankersW<'_, CtrlSpec> {
        BankersW::new(self, 2)
    }
    #[doc = "Bit 4 - User system data program"]
    #[inline(always)]
    pub fn usdprgm(&mut self) -> UsdprgmW<'_, CtrlSpec> {
        UsdprgmW::new(self, 4)
    }
    #[doc = "Bit 5 - User system data erase"]
    #[inline(always)]
    pub fn usders(&mut self) -> UsdersW<'_, CtrlSpec> {
        UsdersW::new(self, 5)
    }
    #[doc = "Bit 6 - Erasing start"]
    #[inline(always)]
    pub fn erstr(&mut self) -> ErstrW<'_, CtrlSpec> {
        ErstrW::new(self, 6)
    }
    #[doc = "Bit 7 - Operation lock"]
    #[inline(always)]
    pub fn oplk(&mut self) -> OplkW<'_, CtrlSpec> {
        OplkW::new(self, 7)
    }
    #[doc = "Bit 9 - User system data unlock success"]
    #[inline(always)]
    pub fn usdulks(&mut self) -> UsdulksW<'_, CtrlSpec> {
        UsdulksW::new(self, 9)
    }
    #[doc = "Bit 10 - Error interrupt enable"]
    #[inline(always)]
    pub fn errie(&mut self) -> ErrieW<'_, CtrlSpec> {
        ErrieW::new(self, 10)
    }
    #[doc = "Bit 12 - Operation done flag interrupt enable"]
    #[inline(always)]
    pub fn odfie(&mut self) -> OdfieW<'_, CtrlSpec> {
        OdfieW::new(self, 12)
    }
    #[doc = "Bit 16 - FAP high level disable"]
    #[inline(always)]
    pub fn fap_hl_dis(&mut self) -> FapHlDisW<'_, CtrlSpec> {
        FapHlDisW::new(self, 16)
    }
    #[doc = "Bit 17 - Low power mode enable"]
    #[inline(always)]
    pub fn lpmen(&mut self) -> LpmenW<'_, CtrlSpec> {
        LpmenW::new(self, 17)
    }
}
