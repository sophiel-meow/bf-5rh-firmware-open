...
impl W {
    #[doc = "Bit 8 - Bus error"]
    #[inline(always)]
    pub fn buserr(&mut self) -> BuserrW<'_, Sts1Spec> {
        BuserrW::new(self, 8)
    }
    #[doc = "Bit 9 - Arbitration lost (master mode)"]
    #[inline(always)]
    pub fn arlost(&mut self) -> ArlostW<'_, Sts1Spec> {
        ArlostW::new(self, 9)
    }
    #[doc = "Bit 10 - Acknowledge failure"]
    #[inline(always)]
    pub fn ackfail(&mut self) -> AckfailW<'_, Sts1Spec> {
        AckfailW::new(self, 10)
    }
    #[doc = "Bit 11 - Overflow or underflow"]
    #[inline(always)]
    pub fn ouf(&mut self) -> OufW<'_, Sts1Spec> {
        OufW::new(self, 11)
    }
    #[doc = "Bit 12 - PEC receive error"]
    #[inline(always)]
    pub fn pecerr(&mut self) -> PecerrW<'_, Sts1Spec> {
        PecerrW::new(self, 12)
    }
    #[doc = "Bit 14 - Timeout error"]
    #[inline(always)]
    pub fn tmout(&mut self) -> TmoutW<'_, Sts1Spec> {
        TmoutW::new(self, 14)
    }
    #[doc = "Bit 15 - SMBus alert"]
    #[inline(always)]
    pub fn alertf(&mut self) -> AlertfW<'_, Sts1Spec> {
        AlertfW::new(self, 15)
    }
}
