...
impl W {
    #[doc = "Bits 0:3 - EXINT 0 configuration bits"]
    #[inline(always)]
    pub fn exint0(&mut self) -> Exint0W<'_, Exintc1Spec> {
        Exint0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - EXINT 1 configuration bits"]
    #[inline(always)]
    pub fn exint1(&mut self) -> Exint1W<'_, Exintc1Spec> {
        Exint1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - EXINT 2 configuration bits"]
    #[inline(always)]
    pub fn exint2(&mut self) -> Exint2W<'_, Exintc1Spec> {
        Exint2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - EXINT 3 configuration bits"]
    #[inline(always)]
    pub fn exint3(&mut self) -> Exint3W<'_, Exintc1Spec> {
        Exint3W::new(self, 12)
    }
}
