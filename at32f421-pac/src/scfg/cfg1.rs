...
impl W {
    #[doc = "Bits 0:1 - Memory address mapping selection bits"]
    #[inline(always)]
    pub fn mem_map_sel(&mut self) -> MemMapSelW<'_, Cfg1Spec> {
        MemMapSelW::new(self, 0)
    }
    #[doc = "Bit 4 - PA11 PA12 Remap"]
    #[inline(always)]
    pub fn pa11_12_rmp(&mut self) -> Pa11_12RmpW<'_, Cfg1Spec> {
        Pa11_12RmpW::new(self, 4)
    }
    #[doc = "Bit 5 - IRTMR Polariyt select"]
    #[inline(always)]
    pub fn ir_pol(&mut self) -> IrPolW<'_, Cfg1Spec> {
        IrPolW::new(self, 5)
    }
    #[doc = "Bits 6:7 - IRTMR source select"]
    #[inline(always)]
    pub fn ir_src_sel(&mut self) -> IrSrcSelW<'_, Cfg1Spec> {
        IrSrcSelW::new(self, 6)
    }
    #[doc = "Bit 8 - ADC DMA remap"]
    #[inline(always)]
    pub fn adc_dma_rmp(&mut self) -> AdcDmaRmpW<'_, Cfg1Spec> {
        AdcDmaRmpW::new(self, 8)
    }
    #[doc = "Bit 9 - USART1 transmit DMA remap"]
    #[inline(always)]
    pub fn usart1_tx_dma_rmp(&mut self) -> Usart1TxDmaRmpW<'_, Cfg1Spec> {
        Usart1TxDmaRmpW::new(self, 9)
    }
    #[doc = "Bit 10 - USART1 receive DMA remap"]
    #[inline(always)]
    pub fn usart1_rx_dma_rmp(&mut self) -> Usart1RxDmaRmpW<'_, Cfg1Spec> {
        Usart1RxDmaRmpW::new(self, 10)
    }
    #[doc = "Bit 11 - TMR16 DMA remap"]
    #[inline(always)]
    pub fn tmr16_dma_rmp(&mut self) -> Tmr16DmaRmpW<'_, Cfg1Spec> {
        Tmr16DmaRmpW::new(self, 11)
    }
    #[doc = "Bit 12 - TMR17 DMA remap"]
    #[inline(always)]
    pub fn tmr17_dma_rmp(&mut self) -> Tmr17DmaRmpW<'_, Cfg1Spec> {
